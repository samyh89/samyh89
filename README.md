...
**To put it simply:** Extremely Customized AI-Agent Systems for Companies around Europe.
...
## 💬Ask me about
- Multi-agent orchestration and MCP tooling
- AI-assisted development workflows in real client engagements (not demos)
- WordPress at production scale
- Web Apps & Desktop Apps
- Sandboxed agent execution environments
- Anything AI. Anything Automation.

## Also
I do graphic design and 3D work outside of code, this has been a hobby of mine nearly 15 years before AI was a thing - 🎨portfolio at [behance.net/mrcatto.](behance.net/mrcatto)
